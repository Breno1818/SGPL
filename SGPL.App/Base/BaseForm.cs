...
namespace SGPL.App.Base
{
    public partial class BaseForm : MaterialForm
    {
        ...
        {
            if (MessageBox.Show(@"Are you sure cancel?", @"SGPL", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ClearFields();
        ...
        {
            if (MessageBox.Show(@"Are you sure you want delete?", @"SGPL", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
            ...
            {
                MessageBox.Show("Please, select any row!", @"SGPL", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
